...
_.copyClipboard = function (dir) {
    ...
    if (failed)
        _.confirm(
            _.label("{count} files in the Clipboard are not readable. Do you want to copy the rest?", {
                count: failed
            }),
            go
        )
...
_.moveClipboard = function (dir) {
    ...
    if (failed)
        _.confirm(
            _.label("{count} files in the Clipboard are not movable. Do you want to move the rest?", {
                count: failed
            }),
            go
        );
...
_.deleteClipboard = function () {
    ...
    if (failed)
        _.confirm(
            _.label("{count} files in the Clipboard are not removable. Do you want to delete the rest?", {
                count: failed
            }),
            go
        );
