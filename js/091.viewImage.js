        ...
        showImage = function (data) {
            ...
            var url = $.$.escapeDirs(_.uploadURL + "/" + _.dir + "/" + data.name) + "?ts=" + ts,
                ...
                onImgLoad = function () {
                    ...
                    var show = function () {
                        ...
                        dlg.parent().animate({
                            ...
                            i.css({
                                padding: top + "px 0 0 " + left + "px",
                                width: i_w,
                                height: i_h
                            }).show();
                            dlg.children().first().css({
                                width: width,
                                height: height,
                                display: "none"
                            }).fadeIn(150, function () {
                                ...
                                dlg.prev().find('.ui-dialog-title').css({
                                    width: width - dlg.prev().find('.ui-dialog-titlebar-close').outerWidth() - 20
                                }).text(title).attr({
                                    title: title
                                }).css({
                                    cursor: "default"
                ...
                loadingStart = function () {
                    if (dlg)
                        dlg.prev().addClass("loading").find('.ui-dialog-title').text(_.label("Loading image...")).css({
                            width: "auto"
                        });
                    else
