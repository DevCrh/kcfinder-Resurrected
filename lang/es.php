...
$lang = array(
  ...
  "Denied file extension." => "Extensión de archivo no permitida.",
  ...
  "Cannot delete the folder." => "No se puede borrar la carpeta.",
  ...
  'Invalid image format. Only JPG/PNG allowed.' => "Formato de imagen no válido. Solo se permiten JPG/PNG.",
  ...
  "Only base64 images are accepted" => "Solo se aceptan imágenes en base64",
  "Error decoding base64" => "Error al decodificar base64",
  // antimalware
  "The uploaded file was detected as possible Malware or corrupted!" => "¡El archivo cargado fue detectado como posible malware o está dañado!",
  // csrf
  "CSRF token missing in session" => "CSRF token ausente en la sesión",
  "Invalid or missing CSRF token" => "CSRF token inválido o ausente",
  "Invalid CSRF token" => "CSRF token inválido",
  "CSRF token not provided" => "Token CSRF no proporcionado",
);